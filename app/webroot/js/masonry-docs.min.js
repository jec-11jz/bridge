...
function(t) {
    ...
    function o(t, i) {
        function o(t, i, s) {
            ...
            "function" == typeof i ? s = i: e(this.options, i),
            s && this.on("always", s),
            this.getImages(),
        ...
        o.prototype.check = function() {
            function t(t, o) {
                return e.options.debug && a && s.log("confirm", t, o),
                e.progress(t),
                i++,
                i === n && e.complete(),
                !0
        ...
        var u = {};
        return h.prototype = new t,
        h.prototype.check = function() {
            var t = u[this.img.src];
            if (t)
                return this.useCached(t),
            void 0;
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var p = r.isBorderBox = !(!u || !n[u] || "border-box" !== n[u]), c = 0, d = a.length; d > c; c++) {
                    var f = a[c],
                    l = n[f];
                    l = o(t, l);
                    var m = parseFloat(l);
                ...
                L = p && h,
                S = e(n.width);
                S !== !1 && (r.width = S + (L ? 0: y + E));
                var w = e(n.height);
                return w !== !1 && (r.height = w + (L ? 0: g + _)),
                r.innerWidth = r.width - (y + E),
                r.innerHeight = r.height - (g + _),
...
function(t) {
    ...
    function o(t, o, r) {
        ...
        a.prototype.moveTo = p ? a.prototype._transitionTo: a.prototype.goTo,
...
function(t) {
    ...
    function s(i, s, c, f, l, m) {
        ...
        y.prototype.destroy = function() {
            ...
            u && u.removeData(this.element, this.settings.namespace)
            },
        y.data = function(t) {
    ...
    function e(t, e) {
        ...
        n.prototype._getItemLayoutPosition = function(t) {
            ...
            for (var r = this._getColGroup(o), s = Math.min.apply(Math, r), a = i(r, s), h = {
                ...
                y: s
            }, u = s + t.size.outerHeight, p = this.cols + 1 - r.length, c = 0; p > c; c++)
                this.colYs[a + c] = u;
            return h
        },
...
function(t) {
    ...
    i.notify = function(t, r) {
        ...
        n.style.opacity = "1",
        r && (o && clearTimeout(o), o = setTimeout(i.hideNotify, h))
        },
                ...
                if (classie.has(o, "item-content")) {
                    ...
                    if (o.style[i] = "", i) {
                        var h = function() {
                            o.style.width = "",
                            o.style.height = "",
                            o.removeEventListener(n, h, !1)
                            };
                        o.addEventListener(n, h, !1)
                        }
                    var u = getSize(s);
                    o.style.width = u.width + "px",
                    o.style.height = u.height + "px",
                    a = null,
                    e.layout()
                    }
            })
...
function(t) {
    "use strict";
    function e() {
        c || (h.notify("Loading examples..."), c = !0, u.getJSON("http://zootool.com/api/users/items/?username=desandro&apikey=8b604e5d4841c2cd976241dd90d319d7&tag=bestofmasonry&offset=" + p + "&callback=?").always(function() {
            c = !1
        }).fail(i).done(n))
        }
    function i() {
        h.notify("could not load examples :(", !0)
        }
    function n(t) {
        if (!t || !t.length)
            return a.style.display = "none",
        h.notify("No more examples", !0),
        void 0;
        h.hideNotify(),
        p += t.length;
        for (var e = [], i = document.createDocumentFragment(), n = 0, u = t.length; u > n; n++) {
            var c = o(t[n]);
            e.push(c),
            i.appendChild(c)
            }
        imagesLoaded(i).on("progress", function(t, e) {
    ...
    h = t.MD,
    u = t.jQuery;
    h.index = function() { (function() {
            var t = document.querySelector("#hero");
            r = t.querySelector(".hero-masonry"),
            s = new Masonry(r, {
        ...
        a = document.querySelector("#load-more-examples"),
        eventie.bind(a, "click", e)
        };
    var p = 0,
    c = !1
} (window),
